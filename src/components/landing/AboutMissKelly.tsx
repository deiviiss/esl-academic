...
const achievements = [
  "Play-based learning for natural language acquisition",
  "Phonics-based foundation for clear pronunciation",
  "Small groups ensuring personalized attention",
  "In-person bilingual environment for children ages 2.8 to 12",
]
        ...
        <div className="grid gap-6 lg:grid-cols-[400px_1fr] lg:gap-12 xl:grid-cols-[600px_1fr]">
          ...
          >
            ...
            <p className="max-w-[600px] text-muted-foreground md:text-lg/relaxed">
              At Miss Kelly ESL Academy, learning English goes beyond memorizing words — it’s about connection,
              confidence, and joy. Through play-based activities, phonics foundations, and small in-person groups,
              children grow naturally into fluent, happy English speakers.
            </p>
